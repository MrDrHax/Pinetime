...
Stopwatch::Stopwatch(Pinetime::Applications::DisplayApp *app) : Screen(app){
    ...
    lv_label_set_text(label_time, "TIME WIZARD");
...
void Stopwatch::stopTimer(){
    ...
    elapsedTime = 1000.; //std::chrono::duration_cast<std::chrono::duration<double>>(endTime - startTime).count(); // get the time difference in seconds
