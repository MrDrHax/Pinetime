...
void lv_style_init(void)
{
    ...
    lv_style_btn_rel.body.main_color     = lv_color_make(227, 174, 30);
    lv_style_btn_rel.body.grad_color     = lv_color_make(222, 136, 16);
    lv_style_btn_rel.body.radius         = 5;
    lv_style_btn_rel.body.padding.left   = 5;
    lv_style_btn_rel.body.padding.right  = 5;
    lv_style_btn_rel.body.padding.top    = 5;
    lv_style_btn_rel.body.padding.bottom = 5;
    lv_style_btn_rel.body.padding.inner  = LV_DPI / 10;
    lv_style_btn_rel.body.border.color   = lv_color_make(200, 200, 200);
    lv_style_btn_rel.body.border.width   = 1;
    lv_style_btn_rel.body.border.opa     = LV_OPA_70;
    lv_style_btn_rel.body.shadow.color   = LV_COLOR_GRAY;
    lv_style_btn_rel.body.shadow.width   = 1;
